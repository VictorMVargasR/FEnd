...
function traerInformacionReservation(){
    $.ajax({
        url:"http://132.226.38.163:8081/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElementoReservation(){
    ...
    $.ajax({
        ...
        url:"http://132.226.38.163:8081/api/Reservation/save",
...
function actualizarElementoReservation(idElemento){
    ...
    $.ajax({
        url:"http://132.226.38.163:8081/api/Reservation/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoReservation(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://132.226.38.163:8081/api/Reservation/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
