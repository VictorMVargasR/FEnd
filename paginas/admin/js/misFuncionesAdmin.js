...
function traerInformacionAdmin(){
    $.ajax({
        url:"http://132.226.38.163:8081/api/Admin/all", //colocar la http del modulo de la tabla CLIENT
        type:"GET",
        datatype:"JSON",
...
function guardarElementoAdmin(){
    ...
    $.ajax({
        ...
        url:"http://132.226.38.163:8081/api/Admin/save",
...
function actualizarElementoAdmin(idElementoA){
    ...
    $.ajax({
        url:"http://132.226.38.163:8081/api/Admin/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoAdmin(idElementoA){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://132.226.38.163:8081/api/Admin/"+idElementoA,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
