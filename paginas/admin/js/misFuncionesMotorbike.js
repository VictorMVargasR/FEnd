...
function traerInformacionC(){
    $.ajax({
        url:"http://132.226.38.163:8081/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElementoMotorbike(){
    ...
    $.ajax({
        ...
        url:"http://132.226.38.163:8081/api/Motorbike/save",
...
function actualizarElementoMotorbike(idElemento){
    ...
    $.ajax({
        url:"http://132.226.38.163:8081/api/Motorbike/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoMotorbike(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://132.226.38.163:8081/api/Motorbike/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
