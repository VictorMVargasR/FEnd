...
function guardarElementoCategory(){
    ...
    $.ajax({
        ...
        url:"http://132.226.38.163:8081/api/Category/save",
...
function actualizarElementoCategory(idElemento){
    ...
    $.ajax({
        url:"http://132.226.38.163:8081/api/Category/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoCategory(idElemento){
    ...
    //console.log(respuestaCategory);
    $.ajax({
        url:"http://132.226.38.163:8081/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
