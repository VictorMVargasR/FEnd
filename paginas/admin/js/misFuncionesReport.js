...
function traerInformacionReporteStatus(){
    $.ajax({
        url:"http://132.226.38.163:8081/api/Reservation/report-status",
        type:"GET",
        datatype:"JSON",
...
function traerInformacionReporteFechas() {
    ...
    $.ajax({
        url: "http://132.226.38.163:8081/api/Reservation/report-dates/" + inicialDate + "/" + finalDate,
        type: "GET",
        datatype: "JSON",
...
function traerInformacionReporteClient(){
    $.ajax({
        url:"http://132.226.38.163:8081/api/Reservation/report-clients", //colocar la http del modulo de la tabla CLIENT
        type:"GET",
        datatype:"JSON",
