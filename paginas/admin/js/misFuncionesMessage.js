...
function traerInformacionMessage(){
    $.ajax({
        url:"http://132.226.38.163:8081/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElementoMessage(){
    ...
    $.ajax({
        ...
        url:"http://132.226.38.163:8081/api/Message/save",
...
function actualizarElementoMessage(idElemento){
    ...
    $.ajax({
        url:"http://132.226.38.163:8081/api/Message/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoMessage(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://132.226.38.163:8081/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
