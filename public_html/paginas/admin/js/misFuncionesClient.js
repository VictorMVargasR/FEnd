...
function traerInformacionClientes(){
    $.ajax({
        url:"http://132.226.38.163:8081/api/Client/all", //colocar la http del modulo de la tabla CLIENT
        type:"GET",
        datatype:"JSON",
...
function actualizarElementoClient(idElementoC){
    ...
    $.ajax({
        url:"http://132.226.38.163:8081/api/Client/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoClient(idElementoC){
    ...
    let dataToSend=JSON.stringify(myDataC);
    $.ajax({
        url:"http://132.226.38.163:8081/api/Client/"+idElementoC,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
