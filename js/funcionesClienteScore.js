...
$.ajax({
    url: "http://132.226.38.163:8081/api/Client/" + 1, //localStorage.getItem("idMoto"),
    type: "GET",
    datatype: "JSON",
...
function enviarCalificacion(index) {
    ...
    $.ajax({
        url: "http://132.226.38.163:8081/api/Score/save",
        type: "POST",
        datatype: "JSON",
        data: dataToSend,
        contentType: "application/json",
...
function cancelarReserva(index)
{
    ...
    console.log(dataToSend);
    $.ajax({
        url: "http://132.226.38.163:8081/api/Reservation/update",
        type: "PUT",
        datatype: "JSON",
        data: dataToSend,
        contentType: "application/json",
